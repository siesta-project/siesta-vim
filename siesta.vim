...
exe 'syn match 	siestaKeys 	/\<'.CP('XMLWrite').'\>/'

exe 'syn match 	siestaKeys 	/\<'.CP('BulkBiasV').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('BulkBiasDirection').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('BulkBiasTolerance').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('kgridFile').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('PDOSkgridFile').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('MDSteps').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('MDMaxCGDispl').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('MDMaxDispl').'\>/'
...
exe 'syn match 	siestaOutput 	/\<'.CP('TBTProjsT').'\>/'
exe 'syn match 	siestaOutput 	/\<'.CP('TBTProjsTAll').'\>/'
exe 'syn match 	siestaOutput 	/\<'.CP('TBTProjsTOut').'\>/'
exe 'syn match 	siestaOutput 	/\<'.CP('TBTProjsDOSA').'\>/'
exe 'syn match 	siestaOutput 	/\<'.CP('TBTProjsDMA').'\>/'
exe 'syn match 	siestaOutput 	/\<'.CP('TBTProjsCOOPA').'\>/'
exe 'syn match 	siestaOutput 	/\<'.CP('TBTProjsCOHPA').'\>/'
exe 'syn match 	siestaOutput 	/\<'.CP('TBTProjsCurrentOrb').'\>/'
...
exe 'syn match 	siestaOutput 	/\<'.CP('TBTSelfEnergySave').'\>/'
exe 'syn match 	siestaOutput 	/\<'.CP('TBTSelfEnergySaveMean').'\>/'
...
exe 'syn match 	siestaOutput 	/\<'.CP('TBTCDFSelfEnergyMPI').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('TSkgridFile').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('TSHartreeFixElec').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('TSHartreeFixFrac').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('TSHartreeOffset').'\>/'
