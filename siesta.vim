...
exe 'syn match 	siestaOutput 	/\<'.CP('TBTGF').'\>/'
...
exe 'syn match 	siestaOutput 	/\<'.CP('TBTDOSAElecsAll').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('HartreeFix').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('HartreeFixPlane').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('TSHartree').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('TSHartreePosition').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('TSElec').'[\._-]*\w\+[\._-]*\(Hartree\|Extend\)\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('TSHartreeBasalPlane').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('TBTTEig').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('TElecsAll').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('TBTTOut').'\>/'
exe 'syn match 	siestaKeys 	/\<'.CP('TBTCurrentOrb').'\>/'
...
exe 'syn match 	siestaKeys 	/\<'.CP('TBTTSHS').'\>/'
